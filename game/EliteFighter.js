...
import { applyParametricLikeness } from './ParametricLikeness.js';
import { applyBodyLikeness } from './BodyLikeness.js';
import { applyHumanoidShell } from './HumanoidShell.js';
...
export class EliteFighter extends UltraFighter{
  constructor(def,slot){
    ...
    applySilhouetteFix(this);applyBodyLikeness(this);applyParametricLikeness(this);applyHumanoidShell(this);addCharacterDetail(this);applyFighterSurface(this.group,this.def);this.combatWear=new CombatWear(this);this.comboChoreo=new ComboChoreography(this);
  }
