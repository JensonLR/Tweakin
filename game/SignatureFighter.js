...
export class SignatureFighter extends EliteFighter{
  constructor(def,slot){super(def,slot);this.specialIndex=-1;this.metrics=freshMetrics();this.facial=new FacialAnimator(this);this.hitReaction=new HitReaction(this);this.comboChoreo=new ComboChoreography(this);this.finisherReaction=0;this.finisherStyle=0;this.finisherSource='';this.introPose=-1;}
