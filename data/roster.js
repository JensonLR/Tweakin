export const ROSTER = [
    {
        ...
        finishers: [{ id: 'boardroom-bomb', name: 'Boardroom Bomb', power: 44, duration: 2.65, flavour: 'A showman feint into a crushing lift-and-slam sequence.' },{ id: 'final-word', name: 'Final Word', power: 47, duration: 2.5, flavour: 'Two heavy hooks, a turn, then a dramatic finishing lariat.' }]
    },
    {
        ...
        finishers: [{ id: 'pressure-point', name: 'Pressure Point', power: 43, duration: 2.35, flavour: 'A precise counter chain ending in a hard rotational takedown.' },{ id: 'closed-line', name: 'Closed Line', power: 45, duration: 2.55, flavour: 'Short body shots into a controlled trip and downward strike.' }]
    },
    {
        ...
        finishers: [{ id: 'rapid-rebuttal', name: 'Rapid Rebuttal', power: 42, duration: 2.2, flavour: 'A fast kick-punch-kick sequence that never gives back space.' },{ id: 'hard-pivot', name: 'Hard Pivot', power: 44, duration: 2.4, flavour: 'A sudden sidestep into a spinning heel and driving knee.' }]
    },
    {
        ...
        finishers: [{ id: 'ground-force', name: 'Ground Force', power: 46, duration: 2.55, flavour: 'A hard clinch turn into a powerful clean mat slam.' },{ id: 'pressure-line', name: 'Pressure Line', power: 45, duration: 2.6, flavour: 'Body pressure, short hooks and a forceful shoulder throw.' }]
    },
    {
        ...
        finishers: [{ id: 'spiral', name: 'The Spiral', power: 42, duration: 2.6, flavour: 'A nervous fake-out snaps into a frantic but clean strike chain.' },{ id: 'its-over', name: 'It Is So Over', power: 44, duration: 2.7, flavour: 'A wobbling retreat reverses into a sudden tackle and strike finish.' }]
    },
    {
        ...
        finishers: [{ id: 'aura-check', name: 'Aura Check', power: 51, duration: 2.45, flavour: 'A single calm counter opens a ruthless lift and power slam.' },{ id: 'absolute-unit', name: 'Absolute Unit', power: 53, duration: 2.8, flavour: 'A crushing body kick into a high-amplitude throw and pose.' }]
    }
];
