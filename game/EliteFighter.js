...
export class EliteFighter extends UltraFighter{
  ...
  snapshot(){return{...super.snapshot(),heldWeapon:this.heldWeapon,combo:this.combo,comboClock:this.comboClock,parryWindow:this.parryWindow,evadeTime:this.evadeTime}}
  applySnapshot(s){super.applySnapshot(s);this.combo=s.combo??this.combo;this.comboClock=s.comboClock??this.comboClock;this.parryWindow=s.parryWindow??0;this.evadeTime=s.evadeTime??0;if((s.heldWeapon??null)!==this.heldWeapon)this.setWeaponVisual(s.heldWeapon??null)}
}
